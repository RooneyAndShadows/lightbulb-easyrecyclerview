...
- Java & AndroidX
  | [v1.0.15](https://github.com/RooneyAndShadows/lightbulb-easyrecyclerview/tree/1.0.15)
...
```gradle
implementation 'com.github.rooneyandshadows:lightbulb-easyrecyclerview:1.0.15'
