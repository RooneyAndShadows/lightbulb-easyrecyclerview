package com.github.rooneyandshadows.lightbulb.easyrecyclerview.plugins.pull_to_refresh
...
import com.github.rooneyandshadows.lightbulb.easyrecyclerview.plugins.pull_to_refresh.refresh_layout.RecyclerRefreshLayout
import com.github.rooneyandshadows.lightbulb.easyrecyclerview.plugins.pull_to_refresh.refresh_layout.RefreshView
...
internal class PullToRefresh<ItemType : EasyAdapterDataModel>(
    ...
    private val refreshLayout: RecyclerRefreshLayout = easyRecyclerView.findViewById(R.id.refreshLayout)
    ...
    fun refresh(showLoading: Boolean = false) {
        ...
        refreshing = true
        onRefreshListener!!.execute(easyRecyclerView)
    }
    ...
    private fun enableRefreshLayout(newState: Boolean) {
        ...
        if (newState) {
            easyRecyclerView.setBounceOverscrollEnabled(false)
        }
    }
