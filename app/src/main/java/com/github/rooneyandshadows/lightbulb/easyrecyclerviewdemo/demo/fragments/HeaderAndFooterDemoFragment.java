...
public class HeaderAndFooterDemoFragment extends BaseFragment {
    private EasyRecyclerView<DemoModel, SimpleAdapter> recyclerView;

    public static HeaderAndFooterDemoFragment getNewInstance() {
        return new HeaderAndFooterDemoFragment();
    }
    ...
    protected BaseFragmentConfiguration configureFragment() {
        return new BaseFragmentConfiguration()
                ...
                .withActionBarConfiguration(new BaseFragmentConfiguration.ActionBarConfiguration(R.id.toolbar)
                        ...
                        .withSubTitle(ResourceUtils.getPhrase(getContextActivity(), R.string.header_and_footer_demo))
    ...
    public View createView(@NonNull LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        return inflater.inflate(R.layout.fragment_demo_header_and_footer, container, false);
    }
    ...
    private void setupRecycler(Bundle savedState) {
        ...
        View headerView = getLayoutInflater().inflate(R.layout.demo_header_item_layout, null);
